		...
		else
		{
			switch(str[i])
			{
				...
				case ' ':
					...
					// some existing wrongly-escaped rules. So far, I only found one, in Khulnasoft:
					// https://github.com/khulnasoft/khulnasoft/blob/204f9ff875be035e620ca1affdf374dd1c610a98/rules/khulnasoft_rules.yaml#L3046
