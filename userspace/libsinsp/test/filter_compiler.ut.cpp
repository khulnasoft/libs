...
TEST(sinsp_filter_compiler, complex_filter)
{
	...
	// This is derived from the Khulnasoft default rule
	// "Unexpected outbound connection destination" coming from here:
	// https://github.com/khulnasoft/khulnasoft/blob/167c5bc6910ba9e48fbd1548686146c9dad850fd/rules/khulnasoft_rules.yaml#L381
	// The rule has been expanded with all its Khulnasoft macros, lists,
