...
public:
	enum severity
	{
		SEV_FATAL = KHULNASOFT_LOG_SEV_FATAL,
		SEV_CRITICAL = KHULNASOFT_LOG_SEV_CRITICAL,
		SEV_ERROR = KHULNASOFT_LOG_SEV_ERROR,
		SEV_WARNING = KHULNASOFT_LOG_SEV_WARNING,
		SEV_NOTICE = KHULNASOFT_LOG_SEV_NOTICE,
		SEV_INFO = KHULNASOFT_LOG_SEV_INFO,
		SEV_DEBUG = KHULNASOFT_LOG_SEV_DEBUG,
		SEV_TRACE = KHULNASOFT_LOG_SEV_TRACE,
	};
