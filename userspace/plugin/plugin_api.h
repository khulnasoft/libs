...
// plugins loaded by the khulnasoft libraries to interact with the state
...
// Khulnasoft libs during a live event capture. The asynchronous events
...
typedef struct
{
	...
	struct
	{
		...
		// KHULNASOFT ORGANIZATION, OTHERWISE IT WON'T PROPERLY COEXIST
		// WITH OTHER PLUGINS.
		//
		uint32_t (*get_id)();
	...
	struct
	{
		...
		// fields can be used in Khulnasoft rule conditions.
		// Required: yes
