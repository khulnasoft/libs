...
The "Functionality" tests of the CI-powered test framework are targeted for Khulnasoft release 0.36.
...
<details>
    <summary>Run <a href="https://github.com/khulnasoft/libs/tree/master/test/drivers"> drivers_test</a> unit tests</summary>
        <ul>
            <li>ubuntu-22.04 (x86_64)</li>
